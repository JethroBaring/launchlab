	...
	<div class="flex flex-col flex-1 gap-10">
		<div class="flex flex-col gap-5 overflow-scroll h-full">
			<div class="flex gap-5 items-center">
				<a href="/admin/startups/applicants">
			...
			<div class="flex-1 overflow-scroll">
				<div class="h-0">
					...
					<div class="divider" />
					<ApplicantAssessment data={data.response} access={data.access}/>
					<div class="flex gap-5 w-full justify-end">
						...
						<form action={`/admin/startups/applicants/${data.params}?/approve`} method="post">
							<button class="btn bg-green-500 hover:bg-green-600 btn-custom text-white normal-case">Accept</button>
						</form>
					</div>
				</div>
			</div>
