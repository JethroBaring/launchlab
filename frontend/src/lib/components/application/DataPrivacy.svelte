...
<div class="flex-1 overflow-scroll px-6" class:hidden={currentActive !== 0}>
	<div class="h-0">

		<label class="label" for="data_privacy">
			<span class="label-text text-base">By accomplishing this form, the following personal information will be collected including,
				...
				ChumCheck Program, DASIG consortium committee and will not be shared with any outside parties
				unless you have prior written consent. Development and Acceleration Support for Innovation
				Growth (DASIG) respects your rights as a data subject under the Data Privacy Act.
				<br /><br />
