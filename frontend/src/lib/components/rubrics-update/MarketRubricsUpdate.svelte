...
<div class="flex gap-3">
	<input type="radio" name="marketReadinessLevel" class="radio" checked={readiness_level.readiness_level === index+1} on:click={() => updateLevel(readiness_level.id, question.id)}>
