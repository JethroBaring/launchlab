...
<div class="flex gap-3">
	<input type="radio" name="marketReadinessLevel" class="radio pointer-events-none" checked={readiness_level.readiness_level === index+1}>
	...
	<table class="table">
		...
		<tbody>
            ...
            <tr class="hover h-10 p-5 rounded-lg">
                ...
                <td class="text-center" ><input type="radio" name={`market${question.level}${i+1}`} value=5 class="radio tooltip pointer-events-none" data-tip={criteria.excellent_description} checked={scores[(index)*6+i].score === 5}/></td>
                <td class="text-center" ><input type="radio" name={`market${question.level}${i+1}`} value=4 class="radio tooltip pointer-events-none" data-tip={criteria.good_description} checked={scores[(index)*6+i].score === 4}/></td>
                <td class="text-center" ><input type="radio" name={`market${question.level}${i+1}`} value=3 class="radio tooltip pointer-events-none" data-tip={criteria.fair_description} checked={scores[(index)*6+i].score === 3}/></td>
