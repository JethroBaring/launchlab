<script lang="ts">
	import { organizationalReadinessLevel } from '$lib/constants';
...
<div class:hidden={currentActive !== 4}>
	{#each organizationalReadinessLevel as question, i}
